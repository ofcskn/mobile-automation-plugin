...
2. Load ASO-optimized description from `.msd/metadata/{appId}/ios/en-US/description.txt` (or ask user)
...
5. After user approves the entity anchor sentence:
   ...
   - Save entity anchor to `.msd/config/{appId}.config.json` → `geo.entityAnchor`
